...
method_info!
{
  ...
  AST exceptions = #[THROWS];  // Create a empty exception clause.
		...
		System.out.println("method desc: "+#method_info.toStringList());
            }
        ;
...
System.out.println("code attr");
        ...
        : max_stack=u2 {System.out.println("max stack: "+max_stack);}
          max_locals=u2 {System.out.println("max stack: "+max_locals);}
          code_length=u4 { code = new byte[code_length]; }
	{System.out.println("code len: "+code_length);}
          ( {codepos < code_length}? bytebuf=u1 {code[codepos++] = bytebuf; System.out.println(bytebuf);} )* {codepos==code_length}?
